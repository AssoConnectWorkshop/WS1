-- Étape 8 : colonnes de l'info-bulle de la carte Access (Form_Carte / module PHP) : technicien
-- prévu, commentaire général du site, dernière visite d'entretien du site, code de l'intervenant
-- (FMC ou sous-traitant) et sous-traitant ponctuel. Colonnes ajoutées en fin de vue.
