-- Étape 8 : colonnes de la liste des sites Access (Form_ListeSiteGenerale / vue ListeSite) :
-- RDV à prendre, donneur d'ordre, tarif 2 clim (redevance filtres), commentaire général,
-- précision du géocodage (filtre « non ROOFTOP »). Colonnes ajoutées en fin de vue.
