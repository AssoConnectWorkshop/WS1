...
- [ ] Reste à faire par l'utilisateur : variables Vercel `RESEND_API_KEY`, `EMAIL_FROM`, `CRON_SECRET` ; paramètres d'application (e-mail SAV, SIRET, n° d'attestation) ; logos dans le bucket `logos` (`fmc.png`, `donneur-<id>.png`) ; exécution du script 6.8.
