...
Attribute VB_Base = "0{0881A18D-AA88-41E6-B7A5-AEF477E6E141}"
...
On Error GoTo Err_CmdMap_Click
 ...
 'NOTE: see this link for Google Map parms>> http://mapki.com/index.php?title=Google_Map_Parameters
     ...
     tmpstr2 = Replace(Replace(Trim(Me.adrcli), "  ", " "), " ", "+")
     tmpstr = tmpstr & tmpstr2 & ",+" & Replace(Trim(Me.codposcli), " ", "+") & ",+" & Replace(Trim(Me.vilcli), " ", "+")
