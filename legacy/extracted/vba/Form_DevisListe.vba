Attribute VB_Name = "Form_DevisListe"
Attribute VB_Base = "0{258AFA41-1448-49BF-8ED9-BC8AB969D508}"
...
'!!!!!!!!!!!!!!!ATTENTION TOUTE MODIF ICI ENGENDRE AUSSI LA MEMEDASN DEVIS LISTE TRAVAUX
...
'27/03/23 Ajout nbrpagfax (qui est le nombre d'ahure main d'oeuvre) OM
...
Req = "INSERT INTO intervention (cptsit, datheuapp,objint,staint,typint,codint,numdevacc,nbrpagfax,mnthtdevpartenaire) VALUES (" + Str(Me.NumeroSite) + ",'" + Str(Date) + "','" + Message + "',1,3,'" + codint + "','" + Me.NumeroDevisInterne + "'," + NbHeuresMO + "," + MontantDevis + ")"
...
'ATTENTION MEME PROCEDURE DANS DEVIS TRAVAUX
'Maj Data
Me.Requery
